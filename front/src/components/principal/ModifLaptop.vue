<script setup>
    ...
    const objectInsertLaptop = reactive({
        idLaptop:route.query.idLaptop,
        idMarque : {},
idProcesseur : {},
idRam : {},
idDisque : {},
    ...
    const handleSubmit = async () => {
        try {
            ...
            const response = await axios.post(url, objectInsertLaptop);
            Object.assign(responseInsertLaptop, response);
...
<template>
    <FormInsert title-props="Modifier le/la laptop" :handle-submit="handleSubmit" submit-message="Modifier">
