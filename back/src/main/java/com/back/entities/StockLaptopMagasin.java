...
public class StockLaptopMagasin {
    @Id
@GeneratedValue(strategy=GenerationType.AUTO)
private Integer id_stock_laptop_magasin;
public Integer getIdStockLaptopMagasin(){ return id_stock_laptop_magasin; }
public void setIdStockLaptopMagasin(Integer o){ id_stock_laptop_magasin=o; }
